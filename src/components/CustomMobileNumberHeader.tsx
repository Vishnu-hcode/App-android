...
const CustomMobileNumberHeader = ({ navigation }: HeaderOptionsProps) => {
  return (
    <View
      style={{
...
export const customMobileNumberHeaderOptions = ({
  navigation,
}: HeaderOptionsProps) => ({
  header: () => <CustomMobileNumberHeader navigation={navigation} />,
