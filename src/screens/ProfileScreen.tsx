...
//       ) : (
//         <Image
//           source={require('../assets/avatar-edit.png')} // fallback image
//           style={styles.photo}
//         />
//       )}

//       <View style={styles.card}>
//         <Text style={styles.detail}>First Name: {user.firstName}</Text>
//         <Text style={styles.detail}>Last Name: {user.lastName}</Text>
